...
async def metrics() -> PlainTextResponse:
    ...
    lines = [
        ...
        *_mode_lines(snapshot["mode"]),
        ...
        "# HELP vertex_proxy_queue_depth Current bounded queue depth by endpoint",
        "# TYPE vertex_proxy_queue_depth gauge",
        f'vertex_proxy_queue_depth{{endpoint="chat"}} {snapshot["queue"]["chat"]["depth"]}',
        f'vertex_proxy_queue_depth{{endpoint="embeddings"}} {snapshot["queue"]["embeddings"]["depth"]}',
        "# HELP vertex_proxy_queue_timeouts_total Requests shed after bounded queue wait expired",
        "# TYPE vertex_proxy_queue_timeouts_total counter",
        f'vertex_proxy_queue_timeouts_total{{endpoint="chat"}} {snapshot["queue"]["chat"]["timeouts_total"]}',
        f'vertex_proxy_queue_timeouts_total{{endpoint="embeddings"}} {snapshot["queue"]["embeddings"]["timeouts_total"]}',
        "# HELP vertex_proxy_queue_admissions_total Requests admitted after bounded queue wait",
        "# TYPE vertex_proxy_queue_admissions_total counter",
        f'vertex_proxy_queue_admissions_total{{endpoint="chat"}} {snapshot["queue"]["chat"]["admitted_total"]}',
        f'vertex_proxy_queue_admissions_total{{endpoint="embeddings"}} {snapshot["queue"]["embeddings"]["admitted_total"]}',
